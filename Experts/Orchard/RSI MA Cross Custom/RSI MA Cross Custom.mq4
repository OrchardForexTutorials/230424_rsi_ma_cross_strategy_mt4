...
bool FillBuffers( int valuesRequired ) {
   ...
   for ( int i = 0; i < valuesRequired; i++ ) {
      ...
      BufferRSI[i]    = iRSI( Symbol(), Period(), InpRSIPeriod, InpRSIAppliedPrice, i );
   }
...
void TradeOpenSLPriceTPRatio( ENUM_ORDER_TYPE type, double volume, string tradeComment, int magic, double stopLossPrice = 0, double takeProfitRatio = 0 ) {
